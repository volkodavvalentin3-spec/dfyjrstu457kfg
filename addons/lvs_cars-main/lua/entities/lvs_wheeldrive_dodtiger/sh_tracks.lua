...
if SERVER then
	...
	function ENT:TracksCreate( PObj )
		...
		local LeftTracksArmor = self:AddArmor( Vector(11,55,8), Angle(0,0,0), Vector(-123,-17,-42), Vector(123,17,42), self.SideArmorHP, self.SideArmor )
		self:SetTrackArmorLeft( LeftTracksArmor, LeftWheelChain )

		local RightTracksArmor = self:AddArmor( Vector(11,-55,8), Angle(0,0,0), Vector(-123,-17,-42), Vector(123,17,42), self.SideArmorHP, self.SideArmor )
