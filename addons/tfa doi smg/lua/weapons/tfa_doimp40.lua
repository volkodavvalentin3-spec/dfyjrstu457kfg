...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_mp40.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_mp40.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_mp40.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.51, -2, 0.53)
