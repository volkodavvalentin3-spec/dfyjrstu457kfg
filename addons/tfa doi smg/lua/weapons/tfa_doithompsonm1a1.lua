...
SWEP.PrintName				= "Thompson M1A1"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_thompsonm1a1.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_thompsonm1a1.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_m1a1.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.245, -2.5, 1.07)
SWEP.IronSightsAng = Vector(0, 0.056, 0)
