...
SWEP.PrintName				= "Thompson M1928"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_thompson1928.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/doi/w_thompson1928.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_m1928a1.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.236, -2.25, 1.048)
SWEP.IronSightsAng = Vector(0.1611, 0.0052, 0)
