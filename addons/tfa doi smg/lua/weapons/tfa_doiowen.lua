...
SWEP.PrintName				= "Owen Mk.I"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_owengun.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_owengun.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Owen.1")		-- script that calls the primary fire sound
...
SWEP.Primary.DefaultClip			= 330	-- Bullets you start with
...
SWEP.IronSightsPos = Vector(-3.76, -2, 2.75)
SWEP.IronSightsAng = Vector(0.25, 1.25, -11.684)

SWEP.RunSightsPos = Vector(-0.04, -0.16, 1.519)
SWEP.RunSightsAng = Vector(-17.9, 24.799, -6.7)
