...
SWEP.PrintName				= "Sten Mk.II"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_sten.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_stenmk2.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Sten.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.615, 0, 2.03)
SWEP.IronSightsAng = Vector(-0.3, -0.0389, 9)
