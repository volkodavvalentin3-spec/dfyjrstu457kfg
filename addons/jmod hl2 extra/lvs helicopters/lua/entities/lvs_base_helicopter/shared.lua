...
ENT.DSArmorDamageReduction = 1.2
...
net.Start("lvs_phys_bullet")
net.SendEntity(ENT)
net.SendBool(isCustomAttachment) if vertolet than true, else false
net.SendUInt(attachment_id)
net.Broadcast()
...
function ENT:LVSPhysBulletShoot(bullet)
