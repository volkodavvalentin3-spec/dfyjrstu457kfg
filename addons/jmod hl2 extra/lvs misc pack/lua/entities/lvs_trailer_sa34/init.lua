...
function ENT:OnSpawn( PObj )
	...
	self.SNDTurret = self:AddSoundEmitter( self:WorldToLocal( Muzzle.Pos ), "lvs/vehicles/cannons/20to30mm_out.mp3", "lvs/vehicles/cannons/20to30mm_in.mp3" )
	self.SNDTurret:SetSoundLevel( 95 )
	self.SNDTurret:SetParent( self, ID )

	local WheelModel = "models/diggerCars/cannons/sa34_wheel.mdl"
	...
	self:AddTrailerHitch( Vector(-78.05,0,-12.18), LVS.HITCHTYPE_FEMALE )
end
...
function ENT:SpawnShell()
	...
	Shell.MDL = "models/props_debris/shellcasing_04.mdl"
