...
ENT.PrintName = "Yak-4"
ENT.Author = "Digger"
ENT.Information = "Soviet World War 2 Light Bomber"
...
ENT.MDL = "models/diggerthings/yak4/1.mdl"
...
ENT.MISSILE_MDL = "models/blu/stuka_bomb.mdl"
ENT.MISSILE_POSITIONS = {
	[1] = Vector(110.37,188.22,72.97),
	[2] = Vector(110.37,-188.22,72.97),
	[3] = Vector(127.17,23.02,55.42),
	[4] = Vector(127.17,-23.02,55.42),
}
...
function ENT:SetPoseParameterMG( weapon )
	...
	self:SetPoseParameter("turret_pitch", -Ang.p-25 )
	self:SetPoseParameter("turret_yaw", Ang.y )
end

function ENT:InitWeapons()
	self.PosLMG = Vector(233.09,0.15,85.63)
	self.DirLMG = 0.25
	...
	weapon.CalcView = function( ent, ply, pos, angles, fov, pod )
		...
		if pod:GetThirdPersonMode() then
			...
			local ID = base:LookupAttachment( "muzle" )
...
ENT.ExhaustPositions = {
	{
		pos = Vector(120.87,117.36,100.43),
		ang = Angle(-90,0,0),
	},
	{
		pos = Vector(120.99,82.97,100.42),
		ang = Angle(-90,0,0),
	},
	{
		pos = Vector(120.87,-117.36,100.43),
