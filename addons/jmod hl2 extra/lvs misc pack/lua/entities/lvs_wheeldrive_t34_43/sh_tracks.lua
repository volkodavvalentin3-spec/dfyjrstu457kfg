...
if SERVER then
	...
	ENT.TrackScrollTexture = "models/diggercars/t34/tracks_43"
	ENT.ScrollTextureData = {
		["$bumpmap"] = "models/diggercars/t34/tracks_43_nm",
		["$phong"] = "1",
		["$alphatest"] = "1",
		["$nocull"] = "1",
		["$phongboost"] = "0.02", 
		["$phongexponent"] = "3",
		["$phongexponenttexture"] = "models/diggercars/t34/tracks_43_spec",
	...
	ENT.TrackLeftSubMaterialMul = Vector(-0.0085,0,0)

	ENT.TrackRightSubMaterialID = 6
	ENT.TrackRightSubMaterialMul = Vector(-0.0085,0,0)
