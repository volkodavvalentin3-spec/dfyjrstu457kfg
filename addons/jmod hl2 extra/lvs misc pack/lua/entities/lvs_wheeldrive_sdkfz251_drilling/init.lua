...
function ENT:OnSpawn( PObj )
	...
	local ID = self:LookupAttachment( "drilling_muzzle_2" )
	local Muzzle = self:GetAttachment( ID )
	self.SNDTurret = self:AddSoundEmitter( self:WorldToLocal( Muzzle.Pos ), "lvs/vehicles/251/flakpanzer_loop_fast.wav", "lvs/vehicles/251/flakpanzer_loop_fast.wav" )
