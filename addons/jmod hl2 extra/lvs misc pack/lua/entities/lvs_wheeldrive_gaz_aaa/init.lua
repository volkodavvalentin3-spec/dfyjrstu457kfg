...
function ENT:OnSpawn( PObj )
	local DriverSeat = self:AddDriverSeat( Vector(4,13,27), Angle(0,-95,-8) )
	local PassengerSeat = self:AddPassengerSeat( Vector(24,-13,32), Angle(0,-85,15) )

	local PassengerSeat1 = self:AddPassengerSeat( Vector(-15,-29,56), Angle(0,0,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-30,-29,56), Angle(0,0,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-45,-29,56), Angle(0,0,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-60,-29,56), Angle(0,0,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-75,-29,56), Angle(0,0,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-90,-29,56), Angle(0,0,0) )

	local PassengerSeat1 = self:AddPassengerSeat( Vector(-15,29,56), Angle(0,180,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-30,29,56), Angle(0,180,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-45,29,56), Angle(0,180,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-60,29,56), Angle(0,180,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-75,29,56), Angle(0,180,0) )
	local PassengerSeat1 = self:AddPassengerSeat( Vector(-90,29,56), Angle(0,180,0) )
