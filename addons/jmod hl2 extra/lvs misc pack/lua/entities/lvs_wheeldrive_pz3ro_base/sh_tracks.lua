...
if SERVER then
	...
	ENT.TrackScrollTexture = "models/diggercars/pz3ro/tracks"
	ENT.ScrollTextureData = {
		["$bumpmap"] = "models/diggercars/pz3ro/tracks_nm",
		["$phong"] = "1",
		["$alphatest"] = "1",
		["$nocull"] = "1",
		["$phongboost"] = "0.2", 
		["$phongexponent"] = "0.2",
		["$phongexponenttexture"] = "models/diggercars/pz3ro/tracks_spec",
