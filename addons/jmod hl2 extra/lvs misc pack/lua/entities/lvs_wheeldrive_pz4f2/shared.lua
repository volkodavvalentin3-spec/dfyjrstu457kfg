...
ENT.MDL = "models/diggercars/pz4/pz4.mdl"
ENT.MDL_DESTROYED = "models/diggercars/pz4/pz4_dead1.mdl"
...
ENT.CannonArmorPenetration1km = 6000
...
function ENT:InitWeapons()
	...
	weapon.HudPaint = function( ent, X, Y, ply )
		local ID = ent:LookupAttachment(  "muzzle_ausfg" )
...
function ENT:AddGunnerWeapons()
	...
	weapon.Attack = function( ent )
		...
		local ID = base:LookupAttachment( "muzzle_mg2" )
