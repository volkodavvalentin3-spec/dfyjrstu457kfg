...
ENT.Base = "lvs_wheeldrive_pz3ro_base"

ENT.PrintName = "Panzer III [L]"
ENT.Author = "Digger"
...
ENT.MDL = "models/diggercars/pz3ro/pz3l.mdl"
ENT.MDL_DESTROYED = "models/diggercars/pz3ro/pz3l_dead.mdl"

ENT.CannonArmorPenetration = 6700
ENT.CannonArmorPenetration1km = 5400
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		local ID = ent:LookupAttachment( "coax_mg_muzzle" )
	...
	weapon.Attack = function( ent )
		local ID = ent:LookupAttachment( "muzzle_j" )
	...
	weapon.Attack = function( ent )
		...
		local ID1 = ent:LookupAttachment( "smoke_1" )
		local ID2 = ent:LookupAttachment( "smoke_2" )
