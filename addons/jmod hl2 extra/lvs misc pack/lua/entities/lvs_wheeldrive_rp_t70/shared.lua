...
ENT.MDL = "models/diggercars/t70/t70.mdl"
ENT.MDL_DESTROYED = "models/diggercars/t70/t70_dead.mdl"
...
ENT.FrontArmor = 2500
ENT.FrontLowArmor = 3500
ENT.TopArmor = 100
ENT.SideArmor = 500
ENT.TurretArmor = 3500
ENT.HatchArmor = 4500
ENT.RearArmor = 1500
...
function ENT:InitWeapons()
	...
	weapon.HudPaint = function( ent, X, Y, ply )
		...
		if Muzzle then
			...
			base:PaintCrosshairCenter( MuzzlePos2D, COLOR_WHITE )
	...
	weapon.OnSelect = function( ent, old, new  )
		local base = ent:GetVehicle()
		if not IsValid( base.GunnerHatch ) then return end
		if not IsValid( base ) then return end
		base.GunnerHatch:Open()
	end
	weapon.OnDeselect = function( ent, old, new  )
		local base = ent:GetVehicle()
		if not IsValid( base.GunnerHatch ) then return end
		if not IsValid( base ) then return end
		base.GunnerHatch:Close()
	end
	self:AddWeapon( weapon, 2 )
