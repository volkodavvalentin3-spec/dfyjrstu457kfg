...
--	self:SetSubMaterial(15, "models/diggercars/t70/periscope") 
	...
	local DriverSeat = self:AddDriverSeat( Vector(19,10,7), Angle(0,-90,10) )
	local GunnerSeat = self:AddPassengerSeat( Vector(-12,11,60), Angle(0,-90,0) )
