...
function ENT:OnSpawn( PObj )
	...
	self:AddFuelTank( Vector(-70,0,15), Angle(0,0,0), 2200, LVS.FUELTYPE_PETROL, Vector(-10,-30,0),Vector(10,30,35) )
		...
		-- front plate
	self:AddArmor( Vector(100,0,20), Angle(30,0,0), Vector(-5,-40,-10), Vector(5,40,10), 4000, self.FrontArmor )

	-- "windscreen"
	self:AddArmor( Vector(95,0,35), Angle(-60,0,0), Vector(-15,-40,-20), Vector(5,40,40), 4000, self.FrontArmor )

	-- side armor
	self:AddArmor( Vector(5,30,15), Angle(0,0,0), Vector(-110,-35,0), Vector(60,15,45), 3000, self.SideArmor )

	self:AddArmor( Vector(5,-30,15), Angle(0,0,0), Vector(-110,-15,0), Vector(60,35,45), 3000, self.SideArmor )


	-- turret
	local TurretArmor = self:AddArmor( Vector(0,18,50), Angle(0,0,0), Vector(-60,-60,0), Vector(60,23,40), 3000, self.TurretArmor )
	...
	-- rear
	self:AddArmor( Vector(-100,0,20), Angle(-15,0,0), Vector(-10,-45,0),Vector(10,45,40), 3000, self.RearArmor )
