...
ENT.PrintName = "T-44 (1945)"
ENT.Author = "SIMER"
ENT.Information = "Я в тылу прячусь"
...
ENT.MDL = "models/simer/lvs_t44_.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(80,34,52), colorA = 150 },
