...
ENT.PrintName = "Valentine Mk.II"
ENT.Author = "SIMER"
ENT.Information = "О вы из Англий?"
...
ENT.MDL = "models/simer/lvs_valentine_sov.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(97,24,40), colorA = 150 },
			{ pos = Vector(97,-23,40), colorA = 150 },
