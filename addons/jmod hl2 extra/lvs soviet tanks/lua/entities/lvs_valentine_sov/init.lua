...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(43,-35,35), Angle(0,0,0), Vector(0,0,0), Vector(33,70,20), 600, self.FrontArmor )
	

	-- side armor left front
	self:AddArmor( Vector(0,11,42), Angle(0,0,0), Vector(-50,-15,-20), Vector(55,25,13), 600, self.SideArmor )

	-- side armor right front
	self:AddArmor( Vector(0,-21,42), Angle(0,0,0), Vector(-50,-15,-20), Vector(55,25,13), 600, self.SideArmor )

	
	-- top armor
	
	self:AddArmor( Vector(-61,-6,41), Angle(-25,0,0), Vector(-31,-28,-20), Vector(16,40,10), 300, self.RearArmor )

	-- turret
	local TurretArmor = self:AddArmor( Vector(0,-5,55), Angle(0,0,0), Vector(-10,-25,0), Vector(60,35,25), 800, self.TurretArmor )
