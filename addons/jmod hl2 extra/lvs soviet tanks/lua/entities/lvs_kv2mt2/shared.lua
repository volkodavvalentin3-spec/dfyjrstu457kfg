...
ENT.PrintName = "KV-2 (1940)"
ENT.Author = "SIMER"
ENT.Information = "Да иди ты нахуй со своим ДОТом"
...
ENT.MDL = "models/simer/lvs_kv2.mdl"
...
ENT.FrontArmor = 8000
ENT.SideArmor = 5500
ENT.TurretArmor = 8000
ENT.RearArmor = 5500

-- ballistics
ENT.ProjectileVelocityCoaxial = 13000
ENT.ProjectileVelocityHighExplosive = 10000
ENT.ProjectileVelocityArmorPiercing = 13000
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(105,-19,60), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		if IsValid( PhysObj ) then
			PhysObj:ApplyForceOffset( -bullet.Dir * 500000, bullet.Src )
		end
		...
		ent:EmitSound("weapons/zara.wav", 75, 100, 1, CHAN_WEAPON )
	end
	weapon.HudPaint = function( ent, X, Y, ply )
		local ID = ent:LookupAttachment( "muzzle" )
