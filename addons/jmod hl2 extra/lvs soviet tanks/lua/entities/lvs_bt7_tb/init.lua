...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(53,-35,37), Angle(28,0,0), Vector(0,0,0), Vector(45,70,20), 600, self.FrontArmor )
	self:AddArmor( Vector(43,-35,42), Angle(0,0,0), Vector(0,0,0), Vector(33,70,20), 600, self.FrontArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(-5,-7,55), Angle(0,0,0), Vector(-20,-20,0), Vector(60,35,35), 800, self.TurretArmor )
