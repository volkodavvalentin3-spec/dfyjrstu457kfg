...
local DriverSeat = self:AddDriverSeat( Vector(0,0,60), Angle(0,-90,0) )
	...
	-- front plate
	self:AddArmor( Vector(115,0,30), Angle(20,0,0), Vector(-30,-50,-10), Vector(20,50,20), 4000, self.FrontArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(50,0,35), Angle(0,0,0), Vector(-70,-65,0), Vector(60,65,65), 3000, self.TurretArmor )
	...
	-- rear
	self:AddArmor( Vector(-130,0,20), Angle(0,0,0), Vector(-10,-55,0),Vector(20,55,45), 3000, self.RearArmor )
