...
function ENT:OnSpawn( PObj )
	...
	local Muzzle = self:GetAttachment( ID )
	self.SNDTurret = self:AddSoundEmitter( self:WorldToLocal( Muzzle.Pos ), "", "" )
	...
	self:AddArmor( Vector(-10,0,50), Angle(0,0,0), Vector(-40,-35,-40), Vector(56,35,15), 800, self.SideArmor )
	...
	self:AddTrailerHitch( Vector(-43,0,15), LVS.HITCHTYPE_MALE )
end
