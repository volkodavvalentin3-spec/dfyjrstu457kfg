...
ENT.MDL = "models/simer/lvs_ba64_ptrd.mdl"
...
-- ballistics
ENT.ProjectileVelocityCoaxial = 18000
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(85,25,40), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.OnThink = function( ent )
		if ent:GetSelectedWeapon() ~= 3 then return end
