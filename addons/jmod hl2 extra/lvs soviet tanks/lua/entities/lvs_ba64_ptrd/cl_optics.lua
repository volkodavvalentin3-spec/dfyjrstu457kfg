...
ENT.OpticsCrosshairColor = Color(0,0,0,350)
ENT.OpticsCrosshairSize = 7
...
local scope = Material( "scops/dt29.png" )
...
function ENT:PaintOptics( Pos2D, Col, PodIndex, Type )
	if Type == 1 then
		...
		self:DrawRotatedText( Type == 3 and "" or "", Pos2D.x + 30, Pos2D.y + 30, "LVS_FONT_PANEL", Color(0,0,0,220), 0)
	end
