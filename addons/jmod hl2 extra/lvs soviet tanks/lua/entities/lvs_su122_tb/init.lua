...
function ENT:OnSpawn( PObj )
   ...
   local Seat1 = self:AddPassengerSeat( Vector(30,-20,65), Angle(0,-90,0) )
	...
	self:AddArmor( Vector(75,-5,60), Angle(0,0,0), Vector(-40,-20,-10), Vector(10,20,20), 1100, self.FrontArmor2 )
	...
	self:AddArmor( Vector(33,0,72), Angle(0,0,0), Vector(-43,-40,-14), Vector(20,40,10), 600, self.RearArmor )
