...
ENT.PrintName = "45mm Leningradka"
ENT.Author = "SIMER"
ENT.Information = "Отстоять Ленинград любой ценной!"
ENT.Category = "[LVS]"
...
ENT.MDL = "models/simer/lvs_45mm_l.mdl"
...
function ENT:InitWeapons()
    ...
    weapon.Attack = function( ent )
		...
		if IsValid( PhysObj ) then
			PhysObj:ApplyForceOffset( -bullet.Dir * 35000, bullet.Src )
		end
	end
