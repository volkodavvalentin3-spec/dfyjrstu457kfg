...
function ENT:OnSpawn( PObj )
   ...
   local Seat1 = self:AddPassengerSeat( Vector(30,-20,65), Angle(0,-90,0) )
	...
	self:AddArmor( Vector(66,0,55), Angle(40,0,0), Vector(5,-55,-10), Vector(55,55,10), self.FrontArmorHP, self.FrontArmor )
	self:AddArmor( Vector(66,0,55), Angle(40,0,0), Vector(-27,-48,-10), Vector(10,48,10), self.FrontArmorHP, self.FrontArmor )
	
	self:AddArmor( Vector(85,-8,55), Angle(0,0,0), Vector(-40,-20,-10), Vector(10,20,20), self.FrontArmorHP, self.FrontArmor2 )
	
	-- side armor left front
	self:AddArmor( Vector(32,35,50), Angle(0,0,20), Vector(-40,-5,-20), Vector(40,15,25), self.SideArmorHP, self.SideArmor )

	-- side armor right front
	self:AddArmor( Vector(32,-35,50), Angle(0,0,-20), Vector(-40,-15,-20), Vector(40,5,25), self.SideArmorHP, self.SideArmor )

	-- side armor left rear
	self:AddArmor( Vector(20,31,50), Angle(0,0,45), Vector(-120,-15,-20), Vector(-29,15,13), self.SideArmorHP, self.SideArmor )

	-- side armor right rear
	self:AddArmor( Vector(20,-31,50), Angle(0,0,-45), Vector(-120,-15,-20), Vector(-29,15,13), self.SideArmorHP, self.SideArmor )

	-- top armor
	self:AddArmor( Vector(-33,0,58), Angle(0,0,0), Vector(-50,-33,-14), Vector(20,33,10), self.RearArmorHP, self.RearArmor )
	self:AddArmor( Vector(33,0,68), Angle(0,0,0), Vector(-43,-36,-14), Vector(20,36,10), self.RearArmorHP, self.RearArmor )
    self:AddArmor( Vector(37,-26,75), Angle(0,0,0), Vector(-14,-13,-14), Vector(14,13,10), self.RearArmorHP, self.RearArmor )
	

	-- rear up
	self:AddArmor( Vector(-100,0,40), Angle(50,0,0), Vector(-10,-45,7),Vector(20,45,34), self.SideArmorHP, self.SideArmor )

	-- rear down
	self:AddArmor( Vector(-100,0,40), Angle(50,0,0), Vector(-10,-50,-17),Vector(20,50,7), self.SideArmorHP, self.SideArmor )
