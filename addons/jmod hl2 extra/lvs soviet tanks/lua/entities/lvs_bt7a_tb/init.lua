...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(55,-35,38), Angle(28,0,0), Vector(0,0,0), Vector(45,70,20), 600, self.FrontArmor )
	self:AddArmor( Vector(43,-35,42), Angle(0,0,0), Vector(0,0,0), Vector(33,70,21), 600, self.FrontArmor )
	

	-- side armor left front
	self:AddArmor( Vector(0,11,49), Angle(0,0,0), Vector(-90,-15,-20), Vector(50,25,15), 600, self.SideArmor )

	-- side armor right front
	self:AddArmor( Vector(0,-21,49), Angle(0,0,0), Vector(-90,-15,-20), Vector(50,25,15), 600, self.SideArmor )

	
	-- top armor
	
	self:AddArmor( Vector(-100,-6,48), Angle(-30,0,0), Vector(-11,-28,0), Vector(16,40,10), 300, self.RearArmor )

	-- turret
	local TurretArmor = self:AddArmor( Vector(-5,-7,55), Angle(0,0,0), Vector(-20,-25,0), Vector(60,40,40), 800, self.TurretArmor )
