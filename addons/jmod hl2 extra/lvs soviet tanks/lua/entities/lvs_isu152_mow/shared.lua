...
ENT.PrintName = "ISU-152 (1943)"
ENT.Author = "SIMER"
ENT.Information = "Да иди ты нахуй квадробер ёбанный"
...
ENT.MDL = "models/simer/isu152_mow.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(100,34,71), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		if ent:GetUseHighExplosive() then
			...
			bullet.SplashDamageRadius = 800
		end
		
		local PhysObj = self:GetPhysicsObject()
	      if IsValid( PhysObj ) then
		  PhysObj:ApplyForceOffset( -Muzzle.Ang:Up() * 200000, Muzzle.Pos )
	    end
