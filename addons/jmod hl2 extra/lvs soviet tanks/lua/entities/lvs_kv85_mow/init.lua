...
function ENT:OnSpawn( PObj )
	...
	-- side armor
	self:AddArmor( Vector(5,36,27), Angle(0,0,0), Vector(-130,-15,0), Vector(80,15,45), 3000, self.SideArmor )

	self:AddArmor( Vector(5,-36,27), Angle(0,0,0), Vector(-130,-15,0), Vector(80,15,45), 3000, self.SideArmor )
	

	-- turret
	local TurretArmor = self:AddArmor( Vector(30,0,65), Angle(0,0,0), Vector(-70,-50,0), Vector(70,50,40), 3000, self.TurretArmor )
