...
function ENT:OnSpawn( PObj )
	...
	local Seat1 = self:AddPassengerSeat( Vector(15,15,75), Angle(0,-90,0) )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(25,0,60), Angle(0,0,0), Vector(-60,-38,0), Vector(34,38,40), 1200, self.TurretArmor )
