...
ENT.PrintName = "T-34/76 (1940)"
ENT.Author = "SIMER"
ENT.Information = "Привет от Кошкина"
...
ENT.MDL = "models/simer/t34_1940.mdl"
ENT.MDL_DESTROYED = "models/simer/prop/d_34.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(88,28,52), colorA = 150 },
			{ pos = Vector(88,-32,52), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 60 - Muzzle.Ang:Forward() * 10
