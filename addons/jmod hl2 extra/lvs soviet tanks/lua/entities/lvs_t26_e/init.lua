...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(14,-45,30), Angle(10,0,0), Vector(0,0,0), Vector(65,90,20), 600, self.FrontArmor )
	self:AddArmor( Vector(-35,-37,40), Angle(0,0,0), Vector(0,0,0), Vector(70,75,20), 600, self.FrontArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(-5,-5,60), Angle(0,0,0), Vector(-45,-17,-5), Vector(45,38,22), 600, self.TurretArmor )
	...
	-- rear up
	self:AddArmor( Vector(-89,-10,5), Angle(-10,0,0), Vector(10,-25,7),Vector(20,45,34), 300, self.SideArmor )
