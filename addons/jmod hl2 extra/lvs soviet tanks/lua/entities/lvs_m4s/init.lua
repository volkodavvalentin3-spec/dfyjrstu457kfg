...
function ENT:OnSpawn( PObj )
	...
	-- front upper wedge
	self:AddArmor( Vector(100,0,60), Angle(30,0,0), Vector(-40,-55,-15), Vector(25,55,-2), 1200, self.FrontArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(10,0,70), Angle(0,0,0), Vector(-50,-40,0), Vector(40,40,40), 1500, self.TurretArmor )
