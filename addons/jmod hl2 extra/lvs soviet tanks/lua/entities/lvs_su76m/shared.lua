...
ENT.PrintName = "SU-76M"
ENT.Author = "SIMER"
ENT.Information = "ПиздецX2"
...
ENT.MDL = "models/simer/su76_mow.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(53,45,49), colorA = 150 },
...
function ENT:CalcMainActivity( ply )
	...
	ply.CalcSeqOverride = ply:LookupSequence( "idle_physgun" )
