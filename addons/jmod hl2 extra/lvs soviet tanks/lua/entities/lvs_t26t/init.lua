...
function ENT:OnSpawn( PObj )
	...
	local DriverSeat = self:AddDriverSeat( Vector(0,0,25), Angle(0,-90,0) )
	DriverSeat.HidePlayer = true
	
	local Seat1 = self:AddPassengerSeat( Vector(-50,28,37), Angle(0,0,0) )
	Seat1.HidePlayer = false
	local Seat2 = self:AddPassengerSeat( Vector(-50,-28,37), Angle(0,180,0) )
	...
	self:AddArmor( Vector(14,-35,30), Angle(10,0,0), Vector(0,0,0), Vector(75,70,20), 600, self.FrontArmor )
	self:AddArmor( Vector(-26,-37,40), Angle(0,0,0), Vector(0,0,0), Vector(60,75,35), 600, self.FrontArmor )
	

	-- side armor left front
	self:AddArmor( Vector(20,30,30), Angle(0,0,0), Vector(-90,-5,-15), Vector(50,15,13), 600, self.SideArmor )

	-- side armor right front
	self:AddArmor( Vector(20,-35,30), Angle(0,0,0), Vector(-90,-5,-15), Vector(50,15,13), 600, self.SideArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(0,0,20), Angle(0,0,0), Vector(0,0,0), Vector(34,38,22), 600, self.TurretArmor )
	...
	-- rear up
	self:AddArmor( Vector(-90,-10,5), Angle(-10,0,0), Vector(10,-25,7),Vector(20,45,34), 300, self.SideArmor )
