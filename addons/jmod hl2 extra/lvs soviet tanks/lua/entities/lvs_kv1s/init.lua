...
function ENT:OnSpawn( PObj )
	...
	self:AddFuelTank( Vector(-40,0,50), Angle(0,0,0), 2600, LVS.FUELTYPE_PETROL, Vector(-22,-37,-32),Vector(12,37,0) )

	-- front plate
	self:AddArmor( Vector(110,23,29), Angle(20,0,0), Vector(-30,-70,-20), Vector(20,20,20), 4000, self.FrontArmor )

	-- "windscreen"
	self:AddArmor( Vector(105,28,32), Angle(-30,0,0), Vector(-15,-70,-30), Vector(10,15,40), 4000, self.FrontArmor )

	-- side armor
	self:AddArmor( Vector(5,30,27), Angle(0,0,0), Vector(-130,-15,0), Vector(80,15,45), 3000, self.SideArmor )
	self:AddArmor( Vector(10,55,55), Angle(0,0,0), Vector(-140,-15,0), Vector(100,15,5), 3000, self.SideArmor )
	self:AddArmor( Vector(5,-30,27), Angle(0,0,0), Vector(-130,-15,0), Vector(80,15,45), 3000, self.SideArmor )
	self:AddArmor( Vector(10,-55,55), Angle(0,0,0), Vector(-140,-15,0), Vector(100,15,5), 3000, self.SideArmor )

	-- turret
	local TurretArmor = self:AddArmor( Vector(30,18,65), Angle(0,0,0), Vector(-60,-60,0), Vector(50,23,40), 3000, self.TurretArmor )
