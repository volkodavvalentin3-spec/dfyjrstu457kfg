...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(-32,31,5), colorG = 0, colorB = 0, colorA = 150 },
			{ pos = Vector(-32,-31,5), colorG = 0, colorB = 0, colorA = 150 },
			
		},
		ProjectedTextures = {
			{ pos = Vector(130,18,17), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true },
			{ pos = Vector(130,-18,17), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true },
		},
	},
	{
	...
	},
	{
		...
		SubMaterialID = 1,
		Sprites = {
			{ pos = Vector(130,18,17), colorB = 200, colorA = 150 },
			{ pos = Vector(130,-18,17), colorB = 200, colorA = 150 },
		},
	},
	{
