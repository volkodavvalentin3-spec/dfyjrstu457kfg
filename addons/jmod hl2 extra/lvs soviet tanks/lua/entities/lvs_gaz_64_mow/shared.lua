...
ENT.MDL = "models/simer/gaz_64.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(-77,25,28), colorG = 0, colorB = 0, colorA = 150 },
			{ pos = Vector(-77,-25,28), colorG = 0, colorB = 0, colorA = 150 },
			
		},
		ProjectedTextures = {
			{ pos = Vector(63,21,43), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true },
			{ pos = Vector(63,-21,43), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true },
		},
	},
	{
	...
	},
	{
		...
		SubMaterialID = 1,
		Sprites = {
			{ pos = Vector(63,21,43), colorB = 200, colorA = 150 },
			{ pos = Vector(63,-21,43), colorB = 200, colorA = 150 },
		},
	},
	{
