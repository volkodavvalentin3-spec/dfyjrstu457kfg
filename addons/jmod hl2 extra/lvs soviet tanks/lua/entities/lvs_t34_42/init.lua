...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(67,0,46), Angle(30,0,0), Vector(17,-55,-10), Vector(50,0,10), self.FrontArmorHP, self.FrontArmor )
	self:AddArmor( Vector(67,0,46), Angle(30,0,0), Vector(-16,-50,-10), Vector(17,0,10), self.FrontArmorHP, self.FrontArmor )

	self:AddArmor( Vector(67,0,46), Angle(30,0,0), Vector(17,0,-10), Vector(50,55,10), self.FrontArmorHP, self.FrontArmor )
	self:AddArmor( Vector(67,0,46), Angle(30,0,0), Vector(-16,0,-10), Vector(17,50,10), self.FrontArmorHP, self.FrontArmor )

	-- side armor left front
	self:AddArmor( Vector(20,31,50), Angle(0,0,45), Vector(-40,-15,-20), Vector(40,15,13), self.SideArmorHP, self.SideArmor )

	-- side armor right front
	self:AddArmor( Vector(20,-31,50), Angle(0,0,-45), Vector(-40,-15,-20), Vector(40,15,13), self.SideArmorHP, self.SideArmor )

	-- side armor left rear
	self:AddArmor( Vector(20,31,50), Angle(0,0,45), Vector(-120,-15,-20), Vector(-40,15,13), self.SideArmorHP, self.SideArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(25,0,60), Angle(0,0,0), Vector(-40,-38,0), Vector(34,38,30), self.TurretArmorHP, self.TurretArmor )
