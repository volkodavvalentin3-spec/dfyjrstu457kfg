...
function ENT:OnSpawn( PObj )
	...
	self:AddFuelTank( Vector(-40,0,50), Angle(0,0,0), 800, LVS.FUELTYPE_PETROL, Vector(-22,-37,-32),Vector(12,37,0) )

	-- front plate
	self:AddArmor( Vector(110,23,29), Angle(20,0,0), Vector(-30,-70,-20), Vector(20,20,20), self.FrontArmorHP, self.FrontArmor )

	-- "windscreen"
	self:AddArmor( Vector(105,28,32), Angle(-30,0,0), Vector(-15,-70,-30), Vector(10,15,40), self.FrontArmorHP, self.FrontArmor )

	-- side armor
	self:AddArmor( Vector(5,40,27), Angle(0,0,0), Vector(-130,-15,0), Vector(80,15,45), self.SideArmorHP, self.SideArmor )

	self:AddArmor( Vector(5,-40,27), Angle(0,0,0), Vector(-130,-15,0), Vector(80,15,45), self.SideArmorHP, self.SideArmor )
	

	-- turret
	local TurretArmor = self:AddArmor( Vector(30,0,65), Angle(0,0,0), Vector(-70,-50,0), Vector(70,50,40), self.TurretArmorHP, self.TurretArmor )
	...
	-- rear
	self:AddArmor( Vector(-150,0,30), Angle(50,0,0), Vector(-10,-55,0),Vector(10,55,65), self.RearArmorHP, self.RearArmor )
