...
ENT.PrintName = "IS-2 (1943)"
ENT.Author = "SIMER"
ENT.Information = "Ну а хули"
...
ENT.MDL = "models/simer/is2_43_mow.mdl"
...
ENT.FrontArmorHP = 400
ENT.SideArmorHP = 200
ENT.TurretArmorHP = 400
ENT.RearArmorHP = 200
ENT.RoofArmorHP = 200
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(95,-15,58), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 160 - Muzzle.Ang:Forward() * 10
