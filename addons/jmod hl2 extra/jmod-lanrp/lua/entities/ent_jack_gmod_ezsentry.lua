...
if(SERVER)then
	...
	function ENT:Use(activator)
		if IsValid(activator) and activator:IsPlayer() then
			...
			if State > 0 then
				if activator:GetSquadID() != self.squad and not self.squad == -1 then return end
	...
	function ENT:FireAtPoint(point, targVel)
		...
		if ProjType == "Bullet" then
			...
			EmitWeaponFarSound(self:GetPos(), "lanrp/realism/weapon/dist/auto/mp40_dist.mp3")
		...
		elseif ProjType == "Buckshot" then
			...
			EmitWeaponFarSound(self:GetPos(), "lanrp/realism/weapon/dist/shotgun/m1912_dist.mp3")
