...
if SERVER then
	...
	function ENT:Initialize()
		...
		self:SetKeyValue("fademindist", "1024") 
		self:SetKeyValue("fademaxdist", "1280") 
	...
	function ENT:Use(activator)
		if JMod.IsAltUsing(activator) and not activator:HasWeapon("wep_jack_gmod_ezbucket") then
