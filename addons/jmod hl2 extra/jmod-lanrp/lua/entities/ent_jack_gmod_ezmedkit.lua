...
if SERVER then
	...
	function ENT:Initialize()
		...
		self:SetKeyValue("fademindist", "3072") 
		self:SetKeyValue("fademaxdist", "3328") 
	...
	function ENT:Use(activator)
		...
		if activator:KeyDown(JMod.Config.General.AltFunctionKey) and activator:IsSlotEmpty(slot) and not activator:HasWeapon("wep_jack_gmod_eztoolbox") then
