...
ENT.Spawnable = true
ENT.Model = "models/props_ww_items/grenade_frag.mdl" -- "models/mechanics/robotics/a2.mdl"
--ENT.Material = "models/mats_jack_nades/stick_grenade"
--ENT.ModelScale=1.25
ENT.SpoonModel = "models/props_ww_items/pin_frag.mdl"
ENT.HardThrowStr = 500
ENT.SoftThrowStr = 300
ENT.JModPreferredCarryAngles = Angle(-90, 0, 0)
ENT.EZspinThrow = true
ENT.PinBodygroup = nil
ENT.SpoonBodygroup = {1, 1}
ENT.DetDelay = 4
...
if SERVER then
	...
	function ENT:Detonate()
		...
		--JMod.Sploom(self.EZowner, self:GetPos(), math.random(10, 20), 10)
		...
		util.BlastDamage(self, self, SelfPos, 512, 200)

		EmitFarSound(self:GetPos(), math.random(914,916), 5000, 10000, 2000, 0)
