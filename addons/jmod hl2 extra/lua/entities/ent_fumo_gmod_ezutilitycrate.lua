...
if SERVER then
	...
	function ENT:Initialize()
		...
		self:SetKeyValue("fademindist", "4536") 
		self:SetKeyValue("fademaxdist", "5096") 
		self:SetRenderMode( RENDERMODE_TRANSCOLOR )
		---
		self:SetResource(0)
		self.MaxResource = 3000 -- SMOL size
		self.EZconsumes = {}
	...
	function ENT:CalcWeight()
		...
		self:GetPhysicsObject():SetMass(150 + Frac)
