...
if SERVER then
	...
	function ENT:TracksCreate( PObj )
		...
		local LeftTracksArmor = self:AddArmor( Vector(40,45,40), Angle(0,0,0), Vector(-150,-15,-40), Vector(70,15,0), 500, self.FrontArmor )
		...
		local RightTracksArmor = self:AddArmor( Vector(40,-45,40), Angle(0,0,0), Vector(-150,-15,-40), Vector(70,15,0), 500, self.FrontArmor )
