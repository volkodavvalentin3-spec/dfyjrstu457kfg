...
ENT.PrintName = "Studebaker US6"
ENT.Author = "SIMER"
ENT.Information = "Susik"
...
ENT.MDL = "models/simer/stb_mow.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(-72,31,10), colorG = 0, colorB = 0, colorA = 150 },
			
		},
		ProjectedTextures = {
			{ pos = Vector(128,18,25), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true },
			{ pos = Vector(128,-18,25), ang = Angle(0,0,0), colorB = 200, colorA = 150, shadows = true },
		},
	},
	{
	...
	},
	{
		...
		SubMaterialID = 1,
		Sprites = {
			{ pos = Vector(128,18,25), colorB = 200, colorA = 150 },
			{ pos = Vector(128,-18,25), colorB = 200, colorA = 150 },
		},
	},
	{
