...
function ENT:OnSpawn( PObj )
	...
	local Seat1 = self:AddPassengerSeat( Vector(0,-15,90), Angle(0,-90,0) )
	Seat1.HidePlayer = true
	local Seat2 = self:AddPassengerSeat( Vector(-55,36,65), Angle(0,0,0) )
	Seat2.HidePlayer = false
	local Seat3 = self:AddPassengerSeat( Vector(-55,-36,65), Angle(0,180,0) )
	Seat3.HidePlayer = false
	local Seat4 = self:AddPassengerSeat( Vector(-85,36,65), Angle(0,0,0) )
	Seat4.HidePlayer = false
	local Seat5 = self:AddPassengerSeat( Vector(-85,-36,65), Angle(0,180,0) )
	...
	self:AddArmor( Vector(100,0,0), Angle(-40,0,0), Vector(0,-55,0), Vector(45,55,20), self.FrontArmorHP, self.FrontArmor )
	self:AddArmor( Vector(70,0,55), Angle(40,0,0), Vector(-20,-55,-20), Vector(55,55,20), self.FrontArmorHP, self.FrontArmor )
	

	-- side armor left front
	self:AddArmor( Vector(0,33,62), Angle(0,0,0), Vector(-95,-40,-40), Vector(75,25,17), self.SideArmorHP, self.SideArmor )

	-- side armor right front
	self:AddArmor( Vector(0,-41,62), Angle(0,0,0), Vector(-95,-15,-40), Vector(75,40,17), self.SideArmorHP, self.SideArmor )

	
	-- top armor
	
	self:AddArmor( Vector(-100,-6,47), Angle(-25,0,0), Vector(-11,-28,0), Vector(16,40,10), self.RearArmorHP, self.RearArmor )

	-- turret
	local TurretArmor = self:AddArmor( Vector(-5,0,70), Angle(0,0,0), Vector(-45,-50,0), Vector(60,50,45), self.TurretArmorHP, self.TurretArmor )
	...
	-- rear up
	self:AddArmor( Vector(-123,0,13), Angle(0,0,0), Vector(10,-55,7),Vector(30,55,60), self.SideArmorHP, self.SideArmor )
