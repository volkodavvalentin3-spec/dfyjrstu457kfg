...
ENT.MDL = "models/simer/lvs_Churchill_7.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(100,-25,50), colorA = 150 },
			{ pos = Vector(100,25,50), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		if ent:GetUseHighExplosive() then
			...
			bullet.HullSize 	= 0
			bullet.Damage	= 350
			bullet.Velocity = 16000-- ent.ProjectileVelocityArmorPiercing
		end
