...
ENT.PrintName = "Mk V Cromwell"
ENT.Author = "SIMER"
ENT.Information = "Tea bitch"
...
ENT.MDL = "models/simer/cromw_mow.mdl"
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 120 - Muzzle.Ang:Forward() * 15
	...
	weapon.OnThink = function( ent )
		...
		if ent._oldSwitchType ~= SwitchType then
			...
			if SwitchType then
				...
				ent:EmitSound("weapons/123_eng.wav",  75, 100, 1, CHAN_WEAPON )
				else
				ent:EmitSound("weapons/122_eng.wav",  75, 100, 1, CHAN_WEAPON )
				end
				ent:SetHeat( 1 )
