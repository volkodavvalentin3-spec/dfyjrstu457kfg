...
ENT.PrintName = "Sturmkanone mit 8,8 cm StuK 43, Sd.Kfz.184"
ENT.Author = "SIMER"
ENT.Information = ""
...
ENT.MDL = "models/simer/ferdinand_tb.mdl"
...
ENT.FrontArmor = 13200
ENT.SideArmor = 1000
ENT.TurretArmor = 13200
ENT.RearArmor = 1000

-- ballistics
ENT.ProjectileVelocityCoaxial = 15000
ENT.ProjectileVelocityHighExplosive = 13000
ENT.ProjectileVelocityArmorPiercing = 25000
...
ENT.ExhaustPositions = {
	{
		pos = Vector(-100.7,-15,56),
		ang = Angle(-150,-0,0),
	},
	{
		pos = Vector(-100.7,16,56),
		ang = Angle(-150,-0,0),
	},
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(97,50,67), colorA = 150 },
			{ pos = Vector(97,-50,67), colorA = 150 },
