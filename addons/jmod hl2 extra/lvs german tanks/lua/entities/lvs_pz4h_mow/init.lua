...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(55,0,79), Angle(80,0,0), Vector(17,-40,-10), Vector(50,40,10), 1300, self.FrontArmor )

	
	self:AddArmor( Vector(85,0,40), Angle(20,0,0), Vector(-30,-39,0), Vector(25,39,10), 1300, self.FrontArmor )
