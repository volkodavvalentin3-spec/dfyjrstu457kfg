...
ENT.PrintName = "Pz.Kpfw. T-34/85(r)"
ENT.Author = "SIMER"
ENT.Information = "sus"
...
ENT.MDL = "models/simer/gt_3485_mow.mdl"
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 5 - Muzzle.Ang:Forward() * 10
...
function ENT:AddGunnerTurret()
	...
	weapon.OnThink = function( ent, active )
		...
		local Yaw = math.Clamp( Ang.y,-130,130)
