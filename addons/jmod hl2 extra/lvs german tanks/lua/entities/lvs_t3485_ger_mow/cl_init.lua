...
function ENT:OnSpawn()
	self:CreateBonePoseParameter( "hatch_d", 35, Angle(0,0,0), Angle(0,90,0), Vector(0,0,0), Vector(0,0,0) )
	self:CreateBonePoseParameter( "hatch_g", 36, Angle(0,0,0), Angle(0,110,0), Vector(0,0,0), Vector(0,0,0) )
	self:CreateBonePoseParameter( "hatch_c", 7, Angle(0,0,0), Angle(0,-90,0), Vector(0,0,0), Vector(0,0,0) )
end
