...
function ENT:OnSpawn( PObj )
	...
	local DriverSeat = self:AddDriverSeat( Vector(10,15,40), Angle(0,-90,0) )
	DriverSeat.HidePlayer = false
	  
	
	
    local Seat1 = self:AddPassengerSeat( Vector(17,-7,50), Angle(0,-90,0) )
    local Seat2 = self:AddPassengerSeat( Vector(17,-27,50), Angle(0,-90,0) )
	local Seat3 = self:AddPassengerSeat( Vector(-18,23,50), Angle(0,-90,0) )
	local Seat4 = self:AddPassengerSeat( Vector(-18,-2,50), Angle(0,-90,0) )
	local Seat5 = self:AddPassengerSeat( Vector(-18,-24,50), Angle(0,-90,0) )
	local Seat6 = self:AddPassengerSeat( Vector(-53,23,50), Angle(0,-90,0) )
	local Seat5 = self:AddPassengerSeat( Vector(-53,-2,50), Angle(0,-90,0) )
	local Seat7 = self:AddPassengerSeat( Vector(-53,-24,50), Angle(0,-90,0) )
	
	
	
	local WheelModel = "models/simer/prop/sd7wh.mdl"
