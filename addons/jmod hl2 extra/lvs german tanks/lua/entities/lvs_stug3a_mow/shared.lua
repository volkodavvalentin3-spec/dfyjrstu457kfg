...
ENT.PrintName = "StuG.III Ausf.A"
ENT.Author = "SIMER"
ENT.Information = "bobs"
...
ENT.MDL = "models/simer/stug3a_mow.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(78,45,55), colorA = 150 },
			{ pos = Vector(80,-42,54), colorA = 150 },
...
local weapon = {}
	...
	weapon.Attack = function( ent )
		...
		grenade:SetPos( ent:LocalToWorld( Vector(-100,10,30) ) )
