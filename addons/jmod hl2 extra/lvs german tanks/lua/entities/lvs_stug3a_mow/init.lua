...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(95,0,37), Angle(112,0,0), Vector(-5,-39,0), Vector(22,39,10), 1300, self.FrontArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(15,0,50), Angle(0,0,0), Vector(-50,-50,0), Vector(54,50,30), 1200, self.TurretArmor )
