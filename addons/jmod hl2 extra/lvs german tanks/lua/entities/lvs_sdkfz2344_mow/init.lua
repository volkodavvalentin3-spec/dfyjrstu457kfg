...
function ENT:OnSpawn( PObj )
    ...
    local DriverSeat = self:AddDriverSeat( Vector(-20,15,43), Angle(0,-90,0) )
	DriverSeat.HidePlayer = false
	
	local Seat1 = self:AddPassengerSeat( Vector(-10,-20,70), Angle(0,-70,0) )
	Seat1.HidePlayer = false
	
	
	local GunnerSeat = self:AddPassengerSeat( Vector(-5,-5,35), Angle(0,90,0) )
