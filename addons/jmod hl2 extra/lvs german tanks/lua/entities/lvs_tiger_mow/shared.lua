...
ENT.PrintName = "Pz.Kpfw.VI «Tiger» Ausf.H"
ENT.Author = "SIMER"
ENT.Information = ""
...
ENT.MDL = "models/simer/tiger_mow.mdl"
ENT.MDL_DESTROYED = "models/simer/prop/d_tg.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(93,62,81), colorA = 150 },
			{ pos = Vector(93,-62,81), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.OnSelect = function( ent )
		ent:TurretUpdateBallistics( ent.CannonArmorPenetration, "muzzle" )
	end
	self:AddWeapon( weapon )
