...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(55,0,79), Angle(80,0,0), Vector(17,-40,-10), Vector(50,40,10), self.FrontArmorHP, self.FrontArmor )

	
	self:AddArmor( Vector(85,0,40), Angle(20,0,0), Vector(-30,-39,0), Vector(25,39,10), self.FrontArmorHP, self.FrontArmor )
	self:AddArmor( Vector(95,0,30), Angle(90,0,0), Vector(-10,-39,0), Vector(15,39,10), self.FrontArmorHP, self.FrontArmor )
	

	-- side armor left
	self:AddArmor( Vector(10,32,53), Angle(0,0,0), Vector(-99,5,-20), Vector(50,15,13), self.SideArmorHP, self.SideArmor )

	-- side armor right
	self:AddArmor( Vector(10,-32,53), Angle(0,0,0), Vector(-99,-15,-20), Vector(50,-5,13), self.SideArmorHP, self.SideArmor )

	-- top armor
	self:AddArmor( Vector(-9,0,53), Angle(0,0,0), Vector(-82,-37,-20), Vector(71,37,13), self.RearArmorHP, self.RearArmor )

	-- turret
	local TurretArmor = self:AddArmor( Vector(-4,0,60), Angle(0,0,0), Vector(-47,-40,0), Vector(36,40,35), self.TurretArmorHP, self.TurretArmor )
	...
	-- rear very down
	self:AddArmor( Vector(-90,0,40), Angle(-5,0,0), Vector(-5,-45,-25), Vector(5,45,23), self.FrontArmorHP, self.FrontArmor )
