...
ENT.PrintName = "Pz.Kpfw.IV Ausf.G"
ENT.Author = "SIMER"
ENT.Information = "jopa_2"
...
ENT.MDL = "models/simer/pz4_g1.mdl"
ENT.MDL_DESTROYED = "models/simer/prop/d_pz4g.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(86,45,59), colorA = 150 },
			
		},
		ProjectedTextures = {
			{ pos = Vector(86,44,58), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 75 - Muzzle.Ang:Forward() * 12
