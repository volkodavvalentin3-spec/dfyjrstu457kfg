...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(85,0,37), Angle(20,0,0), Vector(-30,-39,0), Vector(25,39,10), 1300, self.FrontArmor )
	self:AddArmor( Vector(95,0,30), Angle(90,0,0), Vector(-10,-39,0), Vector(15,39,10), 1300, self.FrontArmor )
	

	-- side armor left
	self:AddArmor( Vector(10,32,53), Angle(0,0,0), Vector(-99,5,-20), Vector(50,15,13), 800, self.SideArmor )

	-- side armor right
	self:AddArmor( Vector(10,-32,53), Angle(0,0,0), Vector(-99,-15,-20), Vector(50,-5,13), 800, self.SideArmor )

	-- top armor
	self:AddArmor( Vector(-9,0,53), Angle(0,0,0), Vector(-82,-37,-20), Vector(71,37,13), 600, self.RearArmor )

	-- turret
	local TurretArmor = self:AddArmor( Vector(-4,0,60), Angle(0,0,0), Vector(-47,-40,0), Vector(36,40,35), 1200, self.TurretArmor )
	...
	-- rear very down
	self:AddArmor( Vector(-90,0,40), Angle(-5,0,0), Vector(-5,-45,-25), Vector(5,45,23), 1200, self.FrontArmor )
	...
	-- ammo rack weakspot
	self:AddAmmoRack( Vector(-10,-30.13,26), Vector(10,0,62.5), Angle(90,90,0), Vector(-9.25,-25.25,-6.25), Vector(9.25,27.25,5.25) )
