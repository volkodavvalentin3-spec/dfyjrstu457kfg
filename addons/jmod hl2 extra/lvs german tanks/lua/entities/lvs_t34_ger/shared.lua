...
ENT.PrintName = "Pz.Kpfw.747(r) 1943 "
ENT.Author = "SIMER"
ENT.Information = "Я свой пацаны я свой"
...
ENT.MDL = "models/simer/pz34_mow.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(63,44,55), colorA = 150 },
