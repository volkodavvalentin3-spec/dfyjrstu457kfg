...
function ENT:OnSpawn( PObj )
	...
	self:AddArmor( Vector(60,0,83), Angle(80,0,0), Vector(17,-40,-10), Vector(50,40,10), 1300, self.FrontArmor )

	self:AddArmor( Vector(45,0,44), Angle(5,0,0), Vector(0,-39,0), Vector(44,39,10), 800, self.SideArmor )
	self:AddArmor( Vector(85,0,40), Angle(40,0,0), Vector(0,-39,0), Vector(15,39,10), 1300, self.FrontArmor )
	self:AddArmor( Vector(90,0,37), Angle(112,0,0), Vector(-5,-39,0), Vector(22,39,10), 1300, self.FrontArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(15,0,60), Angle(0,0,0), Vector(-47,-40,0), Vector(36,40,30), 1200, self.TurretArmor )
	...
	-- rear up
	self:AddArmor( Vector(-90,0,44), Angle(-15,0,0), Vector(-8,-40,0), Vector(23,40,15), 300, self.SideArmor )

	-- rear mid
	self:AddArmor( Vector(-100,0,43), Angle(-60,0,0), Vector(-5,-40,-5), Vector(8,40,6), 800, self.SideArmor )
