...
ENT.MDL = "models/simer/pz21.mdl"
ENT.MDL_DESTROYED = "models/simer/prop/d_pz2.mdl"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(85,38,52), colorA = 150 },
			{ pos = Vector(85,-38,52), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 25 - Muzzle.Ang:Forward() * 24
	...
	weapon.Attack = function( ent )
		...
		if IsValid( PhysObj ) then
			PhysObj:ApplyForceOffset( -bullet.Dir * 45000, bullet.Src )
		end
