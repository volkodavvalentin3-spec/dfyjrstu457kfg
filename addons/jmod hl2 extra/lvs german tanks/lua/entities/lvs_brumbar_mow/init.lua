...
function ENT:OnSpawn( PObj )
	...
	local Seat1 = self:AddPassengerSeat( Vector(-65,40,60), Angle(0,0,0) )
	Seat1.HidePlayer = false
	local Seat2 = self:AddPassengerSeat( Vector(-65,-40,60), Angle(0,180,0) )
	Seat2.HidePlayer = false
	local Seat3 = self:AddPassengerSeat( Vector(-85,40,60), Angle(0,0,0) )
	Seat3.HidePlayer = false
	local Seat4 = self:AddPassengerSeat( Vector(-85,-40,60), Angle(0,180,0) )
	...
	self:AddArmor( Vector(85,0,40), Angle(20,0,0), Vector(-30,-42,0), Vector(25,42,10), 1300, self.FrontArmor )
	self:AddArmor( Vector(98,0,30), Angle(90,0,0), Vector(-10,-42,0), Vector(15,42,10), 1300, self.FrontArmor )
	...
	-- turret
	local TurretArmor = self:AddArmor( Vector(14,0,40), Angle(0,0,0), Vector(-57,-60,0), Vector(56,60,60), 1200, self.TurretArmor )
