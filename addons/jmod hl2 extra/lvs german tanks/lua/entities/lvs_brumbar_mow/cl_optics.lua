...
function ENT:PaintOptics( Pos2D, Col, PodIndex, Type )
	...
	if Type == 1 then
		...
		self:DrawRotatedText( Type == 3 and "HE" or "HEAT", Pos2D.x + 30, Pos2D.y + 30, "LVS_FONT_PANEL", Color(0,0,0,220), 0)
	end
	...
	for i = 0, 40 do
		...
		if i == 1 then
			self:DrawRotatedText( "150", Pos2D.x + x * R0, Pos2D.y + y * R0, "LVS_FONT", Color(0,0,0,200), 90 + ang)
		end
		if i == 2 then
