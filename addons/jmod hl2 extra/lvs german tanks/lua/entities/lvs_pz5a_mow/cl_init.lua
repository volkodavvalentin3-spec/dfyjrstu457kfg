...
function ENT:OnSpawn()
	self:CreateBonePoseParameter( "hatch_d", 41, Angle(0,0,0), Angle(110,0,0), Vector(0,0,0), Vector(0,0,0) )
	self:CreateBonePoseParameter( "hatch_g", 42, Angle(0,0,0), Angle(-110,0,0), Vector(0,0,0), Vector(0,0,0) )
