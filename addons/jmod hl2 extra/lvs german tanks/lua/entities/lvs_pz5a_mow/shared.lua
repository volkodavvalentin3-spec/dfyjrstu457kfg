...
ENT.PrintName = "Pz.Kpfw.V «Panther» Ausf.A"
ENT.Author = "SIMER"
ENT.Information = "furry"
...
ENT.MDL = "models/simer/lvs_pz5a_mow.mdl"
...
ENT.CannonArmorPenetration = 21000
ENT.FrontArmor = 4000
ENT.SideArmor = 100
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(99,44,72), colorA = 150 },
...
ENT.ExhaustPositions = {
   {
		pos = Vector(-131,-13,74),
		ang = Angle(-175,0,0)
	},
	{
		pos = Vector(-131,15,74),
		ang = Angle(-175,0,0)
	},
    {
		pos = Vector(-131,-13,74),
	...
	weapon.OnThink = function( ent )
		...
		if ent._oldSwitchType ~= SwitchType then
			...
			if SwitchType then
				...
				ent:EmitSound("weapons/scream_123.wav")
				ent:SetHeat( 1 )
