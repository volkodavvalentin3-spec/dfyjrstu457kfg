...
ENT.PrintName = "Pz.Kpfw.V «Panther» Ausf.D"
ENT.Author = "SIMER"
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(99,44,71), colorA = 150 },
			{ pos = Vector(99,-42,71), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 160 - Muzzle.Ang:Forward() * 20
