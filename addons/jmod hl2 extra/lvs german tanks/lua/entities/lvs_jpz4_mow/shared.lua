...
ENT.PrintName = "Sd.Kfz.162. Jagdpanzer IV"
ENT.Author = "SIMER"
ENT.Information = ""
...
ENT.MDL = "models/simer/jagdpz4_mow.mdl"
...
ENT.ExhaustPositions = {
	{
		pos = Vector(-100.7,-24,55),
		ang = Angle(-150,-0,0),
	},
	{
		pos = Vector(-100.7,7,55),
		ang = Angle(-150,-0,0),
	},
...
ENT.Lights = {
	{
		Trigger = "main",
		Sprites = {
			{ pos = Vector(91,40,54), colorA = 150 },
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		if ent:GetUseHighExplosive() then
			...
			bullet.SplashDamageType = DMG_BURN]]
			bullet.Velocity = ent.ProjectileVelocityHighExplosive
			bullet.TracerName = "lvs_tracer_autocannon"
			bullet.CustomIpmact = function(pos)

				util.ScreenShake(pos, 20, 20, 1, 1000)
				...
				util.BlastDamageInfo( d, pos, 512 )
				...
				EmitSound( "explosions/artillery_strike_gas_close_0" .. math.random(1,4) .. ".wav", pos, 0, CHAN_AUTO, 1, 90, 0, 100 )
				EmitFarSound(pos, math.random(919,922), 1000, 2000, 2000, 0)
			end
		else
	...
	weapon.Attack = function( ent )
		...
		local ID2 = ent:LookupAttachment( "muzzle_smoke_right" )
