...
function ENT:OnSpawn( PObj )
	...
	local GunnerSeat = self:AddPassengerSeat( Vector(50,10,25), Angle(0,-90,0) )
	GunnerSeat.HidePlayer = true
	self:SetGunnerSeat( GunnerSeat )
	
	local Seat1 = self:AddPassengerSeat( Vector(-45,25,40), Angle(0,0,0) )
	Seat1.HidePlayer = false
	local Seat2 = self:AddPassengerSeat( Vector(-45,-25,40), Angle(0,180,0) )
	...
	self:AddArmor( Vector(50,0,72), Angle(80,0,0), Vector(17,-30,-10), Vector(50,30,5), 1300, self.FrontArmor )
	...
	-- side armor left
	self:AddArmor( Vector(10,15,43), Angle(0,0,0), Vector(-82,5,-20), Vector(40,15,13), 800, self.SideArmor )

	-- side armor right
	self:AddArmor( Vector(10,-15,43), Angle(0,0,0), Vector(-82,-15,-20), Vector(40,-5,13), 800, self.SideArmor )

	-- top armor
	self:AddArmor( Vector(10,0,42), Angle(0,0,0), Vector(-35,-20,-20), Vector(40,20,13), 600, self.RearArmor )

	-- turret
	local TurretArmor = self:AddArmor( Vector(14,0,55), Angle(0,0,0), Vector(-37,-25,0), Vector(26,25,20), 1200, self.TurretArmor )
