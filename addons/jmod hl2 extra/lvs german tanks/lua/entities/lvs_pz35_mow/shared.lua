...
ENT.PrintName = "Pz.Kpfw.35(t)"
ENT.Author = "SIMER"
ENT.Information = "piska"
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src 	= Muzzle.Pos - Muzzle.Ang:Up() * 20 - Muzzle.Ang:Forward() * 13
		bullet.Dir 	= Muzzle.Ang:Up()
		bullet.Spread 	= Vector(0.010,0.010,0.010)
