...
function ENT:OnSpawn( PObj )
	self:AddDriverSeat( Vector(-70,20,-5), Angle(0,-90,0) )
	...
	local WheelModel = "models/simer/prop/wheel_pak43.mdl"
	...
	self:AddTrailerHitch( Vector(-141.7,0,7.4), LVS.HITCHTYPE_FEMALE )
end
...
function ENT:SpawnShell()
	...
	Shell:SetPos( Muzzle.Pos - Muzzle.Ang:Forward() * 250 )
