...
function ENT:OnSpawn( PObj )
	...
	local DriverSeat = self:AddDriverSeat( Vector(-20,17,45), Angle(0,-90,0) )
	...
	local Seat1 = self:AddPassengerSeat( Vector(-20,-17,45), Angle(0,-90,0) )
	...
	self:AddArmor( Vector(44,0,75), Angle(80,0,0), Vector(17,-30,-10), Vector(50,30,5), 1300, self.FrontArmor )

	self:AddArmor( Vector(50,0,35), Angle(15,0,0), Vector(0,-30,0), Vector(30,30,10), 800, self.SideArmor )

	self:AddArmor( Vector(80,0,32), Angle(112,0,0), Vector(-5,-30,0), Vector(15,30,5), 1300, self.FrontArmor )

	-- side armor left
	self:AddArmor( Vector(10,20,46), Angle(0,0,0), Vector(-82,5,-22), Vector(40,15,10), 800, self.SideArmor )

	-- side armor right
	self:AddArmor( Vector(10,-20,46), Angle(0,0,0), Vector(-82,-15,-22), Vector(40,-5,10), 800, self.SideArmor )

	

	-- turret
	local TurretArmor = self:AddArmor( Vector(14,0,55), Angle(0,0,0), Vector(-47,-45,-10), Vector(26,45,34), 1200, self.TurretArmor )
	...
	self:AddAmmoRack( Vector(-10,25,55), Vector(10,0,62.5), Angle(90,90,0), Vector(-9.25,-12.25,-6.25), Vector(2.25,12.25,6.25) )
	self:AddAmmoRack( Vector(-10,-25,55), Vector(10,0,62.5), Angle(90,90,0), Vector(-9.25,-12.25,-6.25), Vector(2.25,12.25,6.25) )
