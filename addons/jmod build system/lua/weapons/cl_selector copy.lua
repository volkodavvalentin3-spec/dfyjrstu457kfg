local SelectorButtons = {
    ...
    },
    {
        ...
        click = function()
            ...
            --form:NumSlider(  "Move multip. (base = 4)", "b_move_mult", "1", "64",0 )
            --form:NumSlider(  "Rotate multip. (base = 4)", "b_rotate_mult", "1", "45",0 )
            --form:NumSlider(  "Rotate/move speed (base = 0.25)", "b_move_speed", "0.05", "0.5", 2 )
