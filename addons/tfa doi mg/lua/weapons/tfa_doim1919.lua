...
SWEP.PrintName				= "M1919"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_m1919.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_m1919.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_M1919.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.971, -2, 1.5)
