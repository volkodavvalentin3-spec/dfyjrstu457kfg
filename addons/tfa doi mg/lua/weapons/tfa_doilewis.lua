...
SWEP.PrintName				= "Lewis"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_lewis.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_lewis.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Lewis.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-3.33, 0, 2.119)
