...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_stg44.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_stg44.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Stg44.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.32, -5, 0.6)
