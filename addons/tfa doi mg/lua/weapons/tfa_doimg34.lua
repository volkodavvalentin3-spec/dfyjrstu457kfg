...
SWEP.PrintName				= "MG 34"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_mg34.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_mg34.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_MG34.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-3.04, -2, 1.759)
