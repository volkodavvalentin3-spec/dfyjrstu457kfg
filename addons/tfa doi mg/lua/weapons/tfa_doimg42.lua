...
SWEP.PrintName				= "MG 42"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_mg42.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_mg42.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_MG42.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.36, -2, 0.959)
