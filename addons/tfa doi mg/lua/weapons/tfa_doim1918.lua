...
SWEP.PrintName				= "M1918"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_bar.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_bar.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Bar.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.12, -1, 1.435)
SWEP.IronSightsAng = Vector(-0.301, 0, 0)
