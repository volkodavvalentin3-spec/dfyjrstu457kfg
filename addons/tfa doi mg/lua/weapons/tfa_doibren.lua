...
SWEP.PrintName				= "Bren"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_bren.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_bren.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Bren.1")		-- script that calls the primary fire sound

SWEP.TrueDistantSound = "LANRP/realism/weapon/dist/mg/mg42_dist.mp3"
...
SWEP.IronSightsPos = Vector(-2.06, 0, 2.349)
SWEP.IronSightsAng = Vector(0, 0.23, 0)
