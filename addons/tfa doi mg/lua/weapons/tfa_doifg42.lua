...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_fg42.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_fg42.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Fg42.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.5775, -5, 0.462)
SWEP.IronSightsAng = Vector(0.68, 0.043, 9)
