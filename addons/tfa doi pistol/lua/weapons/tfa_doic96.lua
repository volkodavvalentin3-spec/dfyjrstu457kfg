...
SWEP.PrintName				= "C96 Mauser"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_c96.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_c96.mdl"	-- Weapon world model
SWEP.UseHands = true
