...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_browninghp.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_browninghp.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_browninghp.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.118, -3, 0.7924)
SWEP.IronSightsAng = Vector(-0.0121, 0.0454, 0)
