...
SWEP.PrintName				= "S&W M1917"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_sw1917.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_sw1917.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_M1917.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.7682, -2, 1.26)
SWEP.IronSightsAng = Vector(-1.677, 0.05, 4.4)
