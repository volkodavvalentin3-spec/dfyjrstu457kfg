...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_m1911.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_m1911.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_M1911.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-1.84, -2, 0.37)
SWEP.IronSightsAng = Vector(0.8, 0, 6.8)
