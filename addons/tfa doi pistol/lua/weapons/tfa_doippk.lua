...
SWEP.PrintName				= "Walther PPK"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_ppk_a.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_ppk.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Ppk.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-1.8856, -1, 0.6876)
SWEP.IronSightsAng = Vector(-0.054, 0.067, 0)
