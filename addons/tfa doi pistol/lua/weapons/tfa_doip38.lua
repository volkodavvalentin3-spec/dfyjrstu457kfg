...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_p38_a.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_p38.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_P38.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-1.882, -1, 0.55)
SWEP.IronSightsAng = Vector(0.16, 0.067, 0)
