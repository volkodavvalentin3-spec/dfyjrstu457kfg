...
SWEP.PrintName				= "Lange P08"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_lugerp08.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_lugerp08.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_P08.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-1.803, -2, 0.914)
SWEP.IronSightsAng = Vector(0.3, 0.0047, 6.5882)
