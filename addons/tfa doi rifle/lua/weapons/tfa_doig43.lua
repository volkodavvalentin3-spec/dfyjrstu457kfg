...
SWEP.PrintName				= "G43"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_g43a7.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_gewehr43.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.IronSightsPos = Vector(-2.439, -4, 0.879)
SWEP.IronSightsAng = Vector(0.1, 0.03, 0)
