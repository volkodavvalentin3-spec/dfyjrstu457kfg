...
SWEP.PrintName				= "M1 Carbine"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_m1carbine.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_m1carbine.mdl"	-- Weapon world model
SWEP.UseHands = true
