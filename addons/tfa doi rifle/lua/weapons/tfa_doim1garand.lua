...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_m1garand.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_m1garand.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.IronSightsPos = Vector(-2.4643, -3, 1.14)
SWEP.IronSightsAng = Vector(-0.4782, 0.055, 0)
