...
SWEP.PrintName				= "G43 Scoped"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_g43a_scoped.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/doi/w_g43_sniper.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_tfa_g43.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.7265, -3, 0.3808)
SWEP.IronSightsAng = Vector(-0.06, -0.03, 0)
...
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "RT", rel = "", pos = Vector(-0.006, -0.25, -.005), angle = Angle(0, 90, 0), size = Vector(0.189, 0.189, 0.189), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

SWEP.RTMaterialOverride = -1 --the number of the texture, which you subtract from GetAttachment
SWEP.RTOpaque = true

SWEP.ScopeReticule = ("scope/zf4_crosshair")
