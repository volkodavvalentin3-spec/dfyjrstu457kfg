...
SWEP.PrintName				= "C96 M1932"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_c96_carbine.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/doi/w_c96_carbine.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_C96.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.3275, 1, 1.14)
