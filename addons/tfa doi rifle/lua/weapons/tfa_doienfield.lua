...
SWEP.PrintName				= "Lee Enfield"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_enfield2.mdl"	-- Weapon view model
...
SWEP.IronSightsPos = Vector(-2.56, -3, 1.519)
