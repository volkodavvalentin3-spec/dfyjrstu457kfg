...
SWEP.PrintName				= "Springfield M1903 Scoped"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_springfield_scoped.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_springfield.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Springfield.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.56, -3, 1.24)
...
--SWEP.VElements = {
--	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "RT", rel = "", pos = Vector(-0.007, -0.1, 0), angle = Angle(0, 90, 0), size = Vector(0.16, 0.16, 0.16), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
--}

SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Weaver", rel = "", pos = Vector(-0.15, -4.6, 0.02), angle = Angle(0, 90, 0), size = Vector(0.16, 0.16, 0.16), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
