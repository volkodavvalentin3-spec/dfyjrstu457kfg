...
SWEP.PrintName				= "Kar 98K"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_kar98k2.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_kar98k.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.IronSightsPos = Vector(-2.575, -3, 1.6)
