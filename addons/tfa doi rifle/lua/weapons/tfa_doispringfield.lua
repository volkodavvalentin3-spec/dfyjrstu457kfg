...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_springfield2.mdl"	-- Weapon view model
...
SWEP.Primary.RPM				= 38		-- This is in Rounds Per Minute
...
SWEP.IronSightsPos = Vector(-2.56, -3, 1.32)
