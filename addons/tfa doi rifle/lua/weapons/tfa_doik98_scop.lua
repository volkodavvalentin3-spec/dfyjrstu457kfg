...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_kar98k_scoped.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_snip_k98.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_tfa_k98.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.56, -2.5, 0.332)
...
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "RT", rel = "", pos = Vector(-0.007, -0.3, 0), angle = Angle(0, 90, 0), size = Vector(0.35, 0.35, 0.35), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

SWEP.RTMaterialOverride = -1 --the number of the texture, which you subtract from GetAttachment
SWEP.RTOpaque = true

SWEP.ScopeReticule = ("scope/kar98k_crosshair")
...
SWEP.EventTable = {
	...
	[ACT_SHOTGUN_RELOAD_START] = {
		{ ["time"] = 26 / 30, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
