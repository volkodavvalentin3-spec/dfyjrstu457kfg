...
SWEP.PrintName				= "MP 34"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_mp34.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/doi/w_mp34.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_mp34.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.599, -1, 1.96)
SWEP.IronSightsAng = Vector(0.1, 0.056, 9)
