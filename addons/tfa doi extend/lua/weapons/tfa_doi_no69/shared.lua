...
SWEP.Contact				= ""
SWEP.PrintName				= "No.69 Grenade"
SWEP.Purpose				= "No.69 grenade with All-ways fuze, will explosion on anything by impact."
SWEP.Type				    = "Great Britain Fragmentation Hand Grenade"
SWEP.Slot					= 4
SWEP.SlotPos				= 99
SWEP.DrawAmmo				= true
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_no69.mdl"

// WORLDMODEL
SWEP.WorldModel				= "models/weapons/doi/w_no69.mdl"
...
SWEP.Primary.Round 			= ("tfa_doi_thrownno96")
SWEP.Velocity = 1200
