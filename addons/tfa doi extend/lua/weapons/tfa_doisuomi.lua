...
SWEP.PrintName				= "Suomi KP/-31"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_suomi.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/khrcw2/doipack/w_suomi.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_suomi.1")		-- script that calls the primary fire sound
SWEP.Primary.RPM				= 780		-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 71		-- Size of a clip
SWEP.Primary.DefaultClip		= 710	-- Bullets you start with
...
SWEP.IronSightsPos = Vector(-3.065, -1.25, 1.4365)
SWEP.IronSightsAng = Vector(0, .04, 0)
