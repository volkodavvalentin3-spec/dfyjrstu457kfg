...
SWEP.PrintName				= "Panzerfaust"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_panzerfaust.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/doi/w_panzerfaust.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("Weapon_Panzerfaust.1")		-- Script that calls the primary fire sound
...
SWEP.ProjectileEntity = "ent_panzerfaust_shell_v2" --Entity to shoot
SWEP.ProjectileVelocity = 5000 --Entity to shoot's velocity
--SWEP.ProjectileModel = "models/weapons/doi/w_panzerfaust_projectile.mdl" --Entity to shoot's model
...
SWEP.SightsPos = Vector(-2.635, 0, 0.239) 
--SWEP.SightsAng = Vector(0.3, 0, 7.034) 
SWEP.SightsAng = Vector(-0.6, 0, 7.034)

SWEP.RunSightsPos = Vector(3.5162, -5, -1.2396)
SWEP.RunSightsAng = Vector(-8.5271, 35.8941, -16.827)
