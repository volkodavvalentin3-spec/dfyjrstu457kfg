...
SWEP.PrintName				= "M1 Carbine Early"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_m1carbine_early.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/doi/w_m1carbine_early.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.IronSightsPos = Vector(-2.47, -3, 1.16)
SWEP.IronSightsAng = Vector(0.2, 0.0355, 0)
