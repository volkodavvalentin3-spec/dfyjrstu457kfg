...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_bazooka.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_doi/w_bazooka.mdl"	-- Weapon world model
...
SWEP.ProjectileModel = "models/weapons/doi/w_bazooka_projectile.mdl" --Entity to shoot's model
...
--SWEP.SightsPos = Vector(-1.721, 0, -0.281) 
--SWEP.SightsAng = Vector(7.5, -1, 14) 
SWEP.SightsPos = Vector(-1.721, 0, -0.281) 
SWEP.SightsAng = Vector(6.5, -1, 14) 
