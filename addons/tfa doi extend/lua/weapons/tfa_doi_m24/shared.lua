...
SWEP.Purpose				= "Successor to the M24 grenade with a 3 second fuse before detonation will devestate foes."
SWEP.Type				    = "German Fragmentation Hand Grenade"
SWEP.Slot					= 4
SWEP.SlotPos				= 99
SWEP.DrawAmmo				= true
...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_stielhandgranate.mdl"
