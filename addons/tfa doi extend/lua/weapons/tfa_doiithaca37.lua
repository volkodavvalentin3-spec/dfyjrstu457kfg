...
SWEP.ViewModel				= "models/weapons/tfa_doi/v_ithaca37_t2.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_doi/w_ithaca37.mdl"	-- Weapon world model
SWEP.UseHands = true
...
SWEP.Primary.Sound			= Sound("Weapon_Ithaca.1")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.0885, -2.5, 1.4)
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD_EMPTY] = {
		{ ["time"] = 6 / 30, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
	...
	--	{ ["time"] = 17 / 30, ["type"] = "lua", ["value"] = function(wep,vm)
	--		if wep and wep.EventShell then
	--			wep:EventShell()
	--		end
	--	end, ["client"] = true, ["server"] = true }
