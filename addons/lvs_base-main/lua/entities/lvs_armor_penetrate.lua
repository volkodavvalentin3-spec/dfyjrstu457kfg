...
local PenSound = {
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 0.wav",
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 1.wav",
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 10.wav",
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 11.wav",
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 2.wav",
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 3.wav",
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 5.wav",
	"LANRP/realism/hit/medium/metal/bullet penetrate metal c 6.wav"
}
...
function ENT:Initialize()
	...
	self:EmitSound(table.Random(PenSound), 95, 100, 1 )
	
	local Eff = EffectData()
	Eff:SetOrigin(Pos)
	Eff:SetNormal(Dir)
	util.Effect("tank_impact", Eff)
end
