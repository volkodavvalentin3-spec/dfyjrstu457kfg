...
local cv_fov = 90 --GetConVar("fov_desired")
local cl_vm_nearwall = true --GetConVar("cl_tfa_viewmodel_nearwall")

local cl_tfa_viewmodel_offset_x = 0--GetConVar("cl_tfa_viewmodel_offset_x")
local cl_tfa_viewmodel_offset_y = 0--GetConVar("cl_tfa_viewmodel_offset_y")
local cl_tfa_viewmodel_offset_z = 0--GetConVar("cl_tfa_viewmodel_offset_z")
local cl_tfa_viewmodel_centered = false--GetConVar("cl_tfa_viewmodel_centered")

local cl_tfa_viewmodel_vp_enabled = true--GetConVar("cl_tfa_viewmodel_vp_enabled")
local cl_tfa_viewmodel_vp_pitch = 0 --GetConVar("cl_tfa_viewmodel_vp_pitch")
local cl_tfa_viewmodel_vp_pitch_is = 1 --GetConVar("cl_tfa_viewmodel_vp_pitch_is")
local cl_tfa_viewmodel_vp_vertical = 0 --GetConVar("cl_tfa_viewmodel_vp_vertical")
local cl_tfa_viewmodel_vp_vertical_is = 1 --GetConVar("cl_tfa_viewmodel_vp_vertical_is")
local cl_tfa_viewmodel_vp_max_vertical = 0 --GetConVar("cl_tfa_viewmodel_vp_max_vertical")
local cl_tfa_viewmodel_vp_max_vertical_is = 1 --GetConVar("cl_tfa_viewmodel_vp_max_vertical_is")
local cl_tfa_viewmodel_vp_yaw = 0 --GetConVar("cl_tfa_viewmodel_vp_yaw")
local cl_tfa_viewmodel_vp_yaw_is = 1 --GetConVar("cl_tfa_viewmodel_vp_yaw_is")

local sv_tfa_recoil_legacy = false--GetConVar("sv_tfa_recoil_legacy")

local cv_customgunbob = true --GetConVar("cl_tfa_gunbob_custom")
...
local function GetClampedCVarFloat(cvar)
	return Clamp(cvar, cvar, cvar)
end

local math_max = math.max

local cl_vm_flip_cv = false--GetConVar("cl_tfa_viewmodel_flip")
local fovmod_add = 0 --GetConVar("cl_tfa_viewmodel_offset_fov")
local fovmod_mult = 1 --GetConVar("cl_tfa_viewmodel_multiplier_fov")
...
function SWEP:CalculateViewModelFlip()
	...
	local cam_fov = self2.LastTranslatedFOV or cv_fov or 90
...
local gunswaycvar = 0.8 --GetConVar("cl_tfa_gunbob_intensity")
local gunswayinvertcvar = true --GetConVar("cl_tfa_gunbob_invertsway")
local sv_tfa_weapon_weight = true --GetConVar("sv_tfa_weapon_weight")
