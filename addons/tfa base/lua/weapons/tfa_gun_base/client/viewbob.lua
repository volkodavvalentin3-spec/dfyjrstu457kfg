...
viewbob_intensity_cvar = 0.8 --GetConVar("cl_tfa_viewbob_intensity")
viewbob_animated_cvar = true --GetConVar("cl_tfa_viewbob_animated")
local oldangtmp
local mzang_fixed
...
function SWEP:CalcView(ply, pos, ang, fov)
	...
	if self2.CameraAngCache and viewbob_animated_cvar then
