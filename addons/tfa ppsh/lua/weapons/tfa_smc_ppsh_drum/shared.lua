...
SWEP.Manufacturer = "Tbilisi" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "SMC Group" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "Fight for Tovarish Voroshilov!" --Purpose Tooltip
...
SWEP.Type = "Russian 7.62x25mm Automatic Sub Machine Gun"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_ppsh.1")
SWEP.Primary.SilencedSound = Sound("TFA_INS2_ppsh.2")
SWEP.Primary.LoopSound = Sound("TFA_PPSH_LOOP.1")
SWEP.Primary.LoopSoundTail = Sound("TFA_PPSH_TAIL.1")

SWEP.TrueDistantSound = "LANRP/realism/weapon/dist/auto/mp40_dist.mp3"
...
SWEP.Primary.RPM = 1023 -- This is in Rounds Per Minute / RPM
...
--Ammo Related
SWEP.Primary.ClipSize = 71 -- This is the size of a clip
SWEP.Primary.DefaultClip = 142 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.Ammo = "7.62x25mm" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--Range Related
SWEP.Primary.Range = 190 * 48 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/smc/ppsh/v_ppsh_drum_mag.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 67		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0.2,-1.5,0.1) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/smc/ppsh/w_ppshdrummag.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.757, -4.218, 0.98)
SWEP.IronSightsAng = Vector(1.34, 3.51, 0)
...
SWEP.RunSightsAng = Vector(-20.5271, 0, 0)
--[[EFFECTS]]--
--Attachments
