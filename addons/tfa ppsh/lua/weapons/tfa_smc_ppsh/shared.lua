...
--Recoil Related
SWEP.Primary.KickUp = 0.255 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/smc/ppsh/v_ppsh_stick_mag.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/smc/ppsh/w_ppshstickmag.mdl" -- Weapon world model path
...
SWEP.ShellAttachment			= "Weapon" 		-- Should be "2" for CSS models or "shell" for hl2 models
